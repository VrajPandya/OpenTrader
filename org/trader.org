...
*** TODO Test Execution Detail response with BackTester.
...
*** TODO Test Commission Report Generation in backTester.
...
** TODO Implement a proper tracking mechanism for order Context and Entries.
*** TODO Figure out the interaction sequence for the context and entries.
Places where the context can be generated:
1. onFilled
Places where entries can be generated:
...
The commission needs to be updatedonce we recive it.

The order in which the calls are updated are non deterministic.
...
** TODO Test the simple context Manager with back tester.
